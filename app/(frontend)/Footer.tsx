            ...
            <div className="footer-social">
              ...
              <div className="footer-social-icons">
                ...
                <a href="#" aria-label="Follow on LinkedIn" className="footer-social-link">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M6.94 5.00C6.94 5.93 6.19 6.68 5.26 6.68C4.33 6.68 3.58 5.93 3.58 5.00C3.58 4.07 4.33 3.32 5.26 3.32C6.19 3.32 6.94 4.07 6.94 5.00ZM7.00 8.48H3.52V20.74H7.00V8.48ZM13.32 8.48H9.86V20.74H13.28V14.34C13.28 10.82 17.84 10.52 17.84 14.34V20.74H21.28V13.06C21.28 7.36 14.86 7.60 13.28 10.38L13.32 8.48Z"/></svg>
                </a>
                <a href="#" aria-label="Follow on Facebook" className="footer-social-link">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01Z"/></svg>
                </a>
              </div>
            </div>
          </div>
